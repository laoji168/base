...
## [git clone 带用户名密码](https://www.cnblogs.com/tonyauto/p/10722563.html)
...
## [linux pip使用国内源](https://www.cnblogs.com/weilijie/p/10957761.html)
...
## centos 7 linux系统安装 mysql5.7.26（glibc版）**
...
[**https://dev.mysql.com/downloads/mysql/5.7.html#downloads**](https://blog.csdn.net/qq_35275233/article/details/89852817#downloads)
...
flush privileges;
alter user user() identified by "123456";或alter user 'root'@'localhost' identified by '123';
```



　　初次登录需要设置密码才能进行后续的数据库操作：SET PASSWORD = PASSWORD('password');（密码设置根据实际提供密码设置） 
...
首先配置允许访问的用户，采用授权的方式给用户权限`GRANT ALL PRIVILEGES ON *.* TO 'root'@'%'IDENTIFIED BY '123456' WITH GRANT OPTION;`最后配置好权限之后不应该忘记刷新使之生效 说明：root是登陆数据库的用户，123456是登陆数据库的密码，*就是意味着任何来源任何主机反正就是权限很大的样子。`flush privileges;`再次访问就可以了吧。开启centOS7的防火墙端口3306：<https://www.cnblogs.com/moxiaoan/p/5683743.html>
...
[CentOS7下解决yum install mysql-server 异常：No package mysql-server available.问题](https://www.cnblogs.com/tijun/p/8651649.html)
...
下载zip的包：
 ...
 ![img](https://images2018.cnblogs.com/blog/1283788/201803/1283788-20180312205748672-517239733.png)
...
path里添加：%MYSQL_HOME%\bin;
 ...
 ![img](https://images2018.cnblogs.com/blog/1283788/201803/1283788-20180312205846348-914208555.png) 
...
执行命令：mysqld --initialize-insecure --user=mysql  在E:\mysql-5.7.20-winx64目录下生成data目录
 ...
 ![img](https://images2018.cnblogs.com/blog/1283788/201803/1283788-20180312205937682-290821417.png)
...
## windows为nodejs安装jsdom

  系统环境win7 

1.下载 nodejs **32bit**的，得到一个node.exe文件 
...
2018年07月10日 15:32:54 [Cand6oy](https://me.csdn.net/Cand6oy) 阅读数：4195
...
File "xxx-sy.py", line 384, in <module> 
...
File "taobao-sexy.py", line 428, in <module> 
...
![img](https://img-blog.csdn.net/2018080121171815?watermark/2/text/aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L3FxXzM2NTI3MzM5/font/5a6L5L2T/fontsize/400/fill/I0JBQkFCMA==/dissolve/70)
...
## 在linux中添加python path

[在Linux添加PYTHONPATH方法以及修改环境变量方法](https://www.cnblogs.com/crazymagic/p/9132309.html)
